...
{
    // TODO: permitir customização de fonte, cores, tamanhos, posições, etc.
        ...
        double? accuracy, double? heading, double? speed)
    {
        ...
        void DrawLine(string text, SKTextAlign align = SKTextAlign.Left)
        {
            foreach (var line in text.Split('\n'))
            {
                ...
                float px = (align == SKTextAlign.Left) ? x - width : x; // Ajuste no alinhamento a direita
        ...
        DrawLine(texto3);
        DrawLine(texto4);
        DrawLine(texto5, SKTextAlign.Right); // Alinhando o último texto a direita
